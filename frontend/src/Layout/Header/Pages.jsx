...
export const authPages = [
    { path: `${process.env.PUBLIC_URL}/login`, type: 'link', title: 'Login Simple' },
    ...
    { path: `${process.env.PUBLIC_URL}/register`, type: 'link', title: 'Register Simple' },
...
export const usefullPages = [
    ...
    { path: `${process.env.PUBLIC_URL}/forget-password`, type: 'link', title: 'Forget Password' },
    { path: `${process.env.PUBLIC_URL}/email-verify`, type: 'link', title: 'Email Verify' },
