    ...
    return (
        <Fragment>
            <Container fluid={true}>
                <Card className='mb-0'>
                    <CardHeader>
                        <H2 attrH6={{ className: 'mb-0' }}>{`Make a Payment`}</H2>
                                                ...
                                                <Col>
                                                    <div className="media">
                                                        <div className="media-body align-self-center">
                                                            <H5>Payment Link</H5>
                                                            <P>Submit an early payment to be applied towards a Scheduled Payment or an extra payment to be applied towards the loan.
                                                                <br />
                                                                A payment method is required to submit a payment!</P>
                                                        </div>
                                                    </div>
                                                </Col>
                                            </Row>
